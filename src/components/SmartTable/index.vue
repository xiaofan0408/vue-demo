        ...
        <div class="head">
          <div class="selset">
            ...
            <select v-model="selectedPageNum" v-on:change="chooosePageNum(selectedPageNum)">
              <option v-for="pageNum in pageNumList" :key="pageNum.num" v-bind:value="pageNum.num">{{pageNum.num}}</option>
            </select>
            <span>条</span>
          </div>
          <div class="search">
        ...
        <div class="foot">
          ...
          <div class="pagination">
              <ul>
                ...
                <li v-for="page in pageList" :key="page.num">
  ...
  watch: {
    searchKey(val, oldval) {
      if (this.getMessage.type === 'async') {
        ...
        const count = this.initData.length
